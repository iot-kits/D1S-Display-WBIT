...
|**Almanac**|<img src="/images/Almanac.jpg" width="200px"/> | <ul><li>Day and date</li> <li>Sun Rise local time (am)</li> <li>Sun Set local time (pm) </li> <li>Moon Phase Graphic & Text</li></ul> |
|**Digital Clock**|<img src="/images/Time-Temp Screen.jpg" width="200px"/> | <ul><li>Universal Coordinated Time (UTC) with seconds</li> <li>Local Time (24-hour) </li> <li>Indoor Temperature & Humidity</li></ul>| 
|**Analog Clock**|<img src="/images/AnalogClock.jpg" width="200px"/> | <ul><li>Local Time with seconds on a 12-hour dial</li><li>Local Timezone Abbreviation</li><li>AM/PM indication</li><li>Indoor Temperature & Humidity if the Digital Clock is not selected</li></ul> | 
